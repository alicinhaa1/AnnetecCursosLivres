...
?>
<title>Sistema de Chamados - CPD</title>
	...
	<div class="panel-heading">
		<div class="row">
			...
			<div class="col-md-2" align="right">
				<button type="button" name="add" id="addUser" class="btn btn-success btn-xs">Novo Chamado</button>
			</div>
		</div>
	</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="form-group"
							...
							<input type="text" class="form-control" id="userName" name="userName" placeholder="Insira seu nome" required>			
						</div>
						...
						<div class="form-group">
							<label for="status" class="control-label">Acesso</label>				
