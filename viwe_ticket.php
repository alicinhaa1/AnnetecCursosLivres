			...
			<div class="col-md-10 col-sm-10">
				<div class="panel panel-default arrow left">
					...
					<button type="button" class="btn btn-danger btn-sm">
					  <span class="glyphicon glyphicon-eye-close"></span> Finalizado
					<?php } else { ?>
			...
			<article class="row">
				<div class="col-md-10 col-sm-10">				
					<div class="form-group">							
						<textarea class="form-control" rows="5" id="message" name="message" placeholder="Escreva aqui..." required></textarea>	
					</div>				
			</div>
			</article>  
			<article class="row">
